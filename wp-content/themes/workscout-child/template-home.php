...
<div class="intro-banner dark-overlay" <?php echo workscout_get_new_search_header();?>>
    ...
    <div class="transparent-header-spacer"></div>
        ...
        <!-- Intro Headline -->
        <div class="row">
            <div class="sixteen columns intro-banner-colums">
                ...
                <div class="intro-banner-search-form">
                        ...
                        <?php if (in_array("keywords", $search_elements)) : ?>
                            ...
                            <div class="intro-search-field">
                                <label for ="intro-keywords" class="field-title ripple-effect"><?php esc_html_e('Job title not in categories or company','workscout') ?></label>
                                <input id="intro-keywords" name="search_keywords" type="text" placeholder="<?php esc_attr_e( 'Job title or company', 'workscout' ); ?>">
                            </div>
                        <?php endif; ?>
                        ...
                        <!-- Search Field -->
                            <div class="intro-search-field with-autocomplete">
                                <label for="search_location" class="field-title ripple-effect"><?php esc_html_e('Location','workscout') ?></label>
                                ...
                                $fixed_dropdown = str_replace("&nbsp;", "", $dropdown); echo $fixed_dropdown;
                                    ...
                                    <div class="input-with-icon location">
                                        <input id="search_location" name="search_location" type="text" placeholder="<?php esc_attr_e('City, State or Country','workscout'); ?>">
